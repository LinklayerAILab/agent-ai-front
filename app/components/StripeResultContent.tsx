...
// Shared payment-result page body. Polls GET /v1/stripe/orders until the
// order turns paid; a pending order past the polling window is NOT a failure
// (delayed payment methods settle later via webhook / reconciliation runner),
// it stays "confirming" and the user is pointed to the order list.
export default function StripeResultContent() {
